...
class ClientFollowerController extends Controller
{
    ...
    public function FollowersList(Request $request)
    {
        try {
            ...
            $followers = ClientFollower::with('customer')->where('status', 1)->where('client_id', $client_id)->latest()->get();
    ...
    public function delete(Request $request)
    {
        try {
            ...
            $follower = ClientFollower::where('id',$client_follower_id)->where('client_id', $client_id)->first();
            $follower->delete();
