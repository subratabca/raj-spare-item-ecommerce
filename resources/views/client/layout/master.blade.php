    ...
    function getNotificationLink(notification) {
        if (notification.data) {
            ...
            if (notification.data.order_id) {
                ...
                return `/client/complain/details/${notification.data.complain_id}?notification_id=${notificationId}`;
            } else if (notification.data.food_id) {
                return `/client/food/details/${notification.data.food_id}?notification_id=${notificationId}`;
