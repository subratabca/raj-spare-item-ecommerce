...
<script>
    ...
    async function getList() {
        ...
        showLoader();
        try {
            let res = await axios.get("/client/order/list/by/customer/info/" + customer_id);
            ...
            if (res.data.data.length === 0) {
                ...
                res.data.data.forEach(function (item, index) {
                    let row = `
                        <tr>
                            <td>${index + 1}</td>
                            <td>${item['food']['image'] ? `<img src="/upload/food/small/${item['food']['image']}" width="50" height="50">` : `<img src="/upload/no_image.jpg" width="50" height="50">`}</td>
                            ...
                            <td>
                            <a href="/client/order/details/${item['id']}" class="btn btn-sm btn-outline-primary"><span class="mdi mdi-eye-circle"></span></a>
                            </td>
                         </tr>`;
