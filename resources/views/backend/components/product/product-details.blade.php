<div class="card">
    <div class="card-header header-elements">
        <span class="me-2"><h5>Item Details Information</h5></span>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <th><a href="/admin/terms-conditions/details/food_upload" target="_blank"><strong>Item Upload T&C :</strong></a></th>
...
<script>
  ...
  async function FoodDetailsInfo() {
    ...
    try {
      ...
      let firstName = foodData['user']['firstName'];;
      let lastName = foodData['user']['lastName'];
      ...
      document.getElementById('food-description').innerHTML = foodData['description'];
      document.getElementById('food-collection-address').innerText = foodData['address1'];
      ...
      document.getElementById('food-provider').innerText = fullName;
