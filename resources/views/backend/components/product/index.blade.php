<div class="card">
    <div class="card-header header-elements">
        <span class="me-2"><h5>Item List Information</h5></span>
        <div class="card-header-elements ms-auto">
            <a href="/admin/create/food" type="button" class="btn btn-primary waves-effect waves-light">
                <span class="tf-icon mdi mdi-plus me-1"></span>Add New Item
            </a>
        </div>
    </div>
            ...
            res.data.data.forEach(function (item, index) {
                ...
                let row = `
                    <tr>
                        ...
                        <td>
                            <a  href="/admin/product/details/${item['id']}" class="btn btn-sm btn-outline-primary"><span class="mdi mdi-eye-circle"></span>
                            </a>

                            <a href="/admin/edit/product/${item['id']}" class="btn btn-sm btn-outline-success"><span class="mdi mdi-pencil-outline"></span>
                            </a>

                            <a href="/admin/edit/product/multi-image/${item['id']}" class="btn btn-sm btn-outline-info"><span class="mdi mdi-image-edit-outline"></span>
                            </a>
