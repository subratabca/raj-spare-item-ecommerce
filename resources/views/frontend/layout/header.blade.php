    ...
    if (isTokenValid()) {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                document.getElementById('common-image').src = userData['image'] ? "/upload/user-profile/small/" + userData['image'] : "/upload/no_image.jpg";
                document.getElementById('common-firstName').innerText = userData.firstName;
    ...
    try {
        ...
        if (res.status === 200) {
            ...
            if (count > 0) {
                ...
                cartCountElem.innerText = '0'; // Optional: Reset count display
            }
        }
    } catch (error) {
...
async function updateWishlistCount() {
    try {
        ...
        console.error('Wishlist count update failed:', error);
    }
}
</script>
