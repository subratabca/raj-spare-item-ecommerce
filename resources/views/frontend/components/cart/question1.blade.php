...
class CartController extends Controller
{
    ...
    public function getCartProduct(Request $request)
    {
        try {
            ...
            $cartItems = Cart::with([
                'product:id,name,price,image,client_id',
                'product.client:id,firstName,lastName',
                'productVariant:id,color,size'
            ])
...
Remember this above code.Next question will depends tis code.No need to explain this code now.Just remember.