...
<div class="authentication-inner row m-0">
  <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
    <img
      src="{{ asset('frontend/assets/img/illustrations/auth-login-illustration-light.png') }}"
      class="auth-cover-illustration w-100"
      alt="auth-illustration"
      data-app-light-img="illustrations/auth-login-illustration-light.png"
      data-app-dark-img="illustrations/auth-login-illustration-dark.png" />
    <img
      src="{{ asset('frontend/assets/img/illustrations/auth-cover-login-mask-light.png') }}"
      class="authentication-image"
      alt="mask"
      data-app-light-img="{{ asset('frontend/assets/img/illustrations/auth-cover-login-mask-light.png') }}"
      data-app-dark-img="{{ asset('frontend/assets/img/illustrations/auth-cover-login-mask-dark.png') }}" />
  </div>
  ...
  <div
    ...
    <div class="w-px-400 mx-auto pt-5 pt-lg-0">
      ...
      <form id="formAuthentication">
        <div id="account-not-active-message" class="text-danger mb-3 d-none"></div>
        ...
        <div class="mb-3 d-flex justify-content-between">
          ...
          <a href="{{ url('/user/sendOtp') }}" class="float-end mb-1">
      ...
      <div class="d-flex justify-content-center gap-2">
        <a href="/auth/facebook" class="btn btn-icon btn-lg rounded-pill btn-text-facebook">
          <i class="tf-icons mdi mdi-24px mdi-facebook"></i>
        </a>

        <a href="/auth/twitter" class="btn btn-icon btn-lg rounded-pill btn-text-twitter">
          <i class="tf-icons mdi mdi-24px mdi-twitter"></i>
        </a>

        <a href="/auth/google" class="btn btn-icon btn-lg rounded-pill btn-text-google-plus">
